...
## Microsoft Defender blocks the download

Security software can occasionally flag a UnityPackage during download, including through reputation-based or machine-learning detection.

- Download again from your BOOTH purchase library.
- Confirm the exact detection name and affected filename in Windows Security.
- Compare the product version with any security verification result published by the seller.
