...
The **Rest Vertex Data Baker** is a support or advanced-maintenance tool. It is not normally needed during everyday use.

## Tessellated droplets pass through clothing

Apply **RealSweatSystem Clothing Fix** to the affected clothing, or turn **3D Effect (Photos Only, High Load)** off to use No Tess.
