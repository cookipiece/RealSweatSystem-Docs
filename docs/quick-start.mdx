...
[![Unity上部メニューのCookiToolsからRealSweatSystem Setup／Uninstallを開く位置](/img/guide/setup-menu-path.jpg)](/img/guide/setup-menu-path.jpg)
...
[![RealSweatSystem Setupの日本語Install画面](/img/guide/setup-japanese.jpg)](/img/guide/setup-japanese.jpg)
